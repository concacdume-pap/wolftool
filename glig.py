...
try :
    ...
    os.system("pip install pystyle rich bs4")
def countdown(time_sec):
    for remaining_time in range(time_sec, -1, -1):
        colors = [
            "\033[1;35mP\033[1;36mh\033[1;35mu\033[1;32mu\033[1;31mo\033[1;34mc\033[1;35mA\033[1;36mn - Tool\033[1;36m Vip \033[1;31m\033[1;32m"
        ]
        for color in colors:
...
def INSTAGRAM():
    ...
    for data in checkurl1_2['data'] :
        ...
        i += 1
    print('\033[97m════════════════════════════════════════════════')
    choose = int(input('\033[1;92mNhập Tài Khoản : '))
    ...
    if choose >=1 or choose <= len(user_INS) :
        ...
        os.system('cls' if os.name== 'nt' else 'clear')
        banner()
        choose = int(input(Fore.RED+'\033[1;92mNhập Số Lượng Job : '))
        headerINS = {
                'accept': '*/*',
